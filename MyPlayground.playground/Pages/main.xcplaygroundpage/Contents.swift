 ...
 */
func sayBirthPlace(City: String) {
    let City = "Norwalk"
 ...
 */
func sayBestFriend(Name: String) {
    print("Hello \(Name), you are my best friend!!")
}

print(sayBestFriend("Dave"))
print(sayBestFriend("Matt"))
print(sayBestFriend("Emily"))
 ...
 */
func sayKingofJungle() {
    var Animal = "Gorillas"
    print("\(Animal), are most definately the king of the jungle!!")
    Animal = "Jaguars"
    print("\(Animal), are most definately the king of the jungle!!")
}
