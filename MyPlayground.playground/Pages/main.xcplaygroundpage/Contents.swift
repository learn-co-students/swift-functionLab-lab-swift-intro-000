 ...
 */
func myFunc() {
    let myCoolFunction = "Hello Playground how are you doing?"
...
func personName(name: String){
    let nameOf = "Hi my name is \(name)"
    print(nameOf)
}

personName(name: "Avinash")
personName(name: "Levindra")
personName(name: "Anthony")
 ...
 */
let firstName = "Sarah"
personName(name: firstName)

var secondName = "Louis"
personName(name: secondName)
secondName = "Rabbit"
personName(name: secondName)
 ...
 */
func heyThere(){
    var hello = "How's everything going "
    print(hello)
