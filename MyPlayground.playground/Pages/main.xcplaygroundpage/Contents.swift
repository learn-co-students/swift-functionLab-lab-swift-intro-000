 ...
 */
func whosThatGirl(name: String) {
    print("\(name)'s that girl")
}

whosThatGirl(name: "Eve")
whosThatGirl(name: "Marc")
 ...
 */
var anotherOne = "Khaled"
whosThatGirl(name: anotherOne)
anotherOne = "Asahd"
whosThatGirl(name: anotherOne)
