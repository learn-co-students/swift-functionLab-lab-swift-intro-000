 ...
 */
func myFunction(){
    let myMessage = "Hi, how you doing world?"
    print(myMessage)
}
...
func greetUser(name: String){
        print("Hello \(name), welcome to my project!")
}
 ...
 */
func myVariableManuiption(){
    var myVar = "Dummy Value"
    print("\(myVar), testing")
    var newVar = myVar
    print("\(newVar), testing")
}
myVariableManuiption()
myVariableManuiption()
//2 Twice of the variable.
