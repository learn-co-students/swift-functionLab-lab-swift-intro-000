...
var wifesName = "Ida"
printName(name: wifesName)

//Same behavior with string variable as string literal.
...
func printVariable() {
    var variable = "Original variable."
    print(variable)
...
//Same variable prints twice with both variations each time printVariable function is called.
