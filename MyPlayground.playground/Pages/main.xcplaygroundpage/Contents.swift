...
// Ill see my greeting with the specified name.

greetPerson(name: "Peter")
greetPerson(name: "Jonas")
greetPerson(name: "Johanna")
greetPerson(name: "Maya")
 ...
 */
let nameOne = "Alfonso"
greetPerson(name: nameOne)

var nameTwo = "Elizabeth"
greetPerson(name: nameTwo)
...
func luckyNumber() {
    var number = 10
    print("\(number), is todays lucky number!")
    number = number + 15
    print("\(number), is now the new lucky number of today!")
}
