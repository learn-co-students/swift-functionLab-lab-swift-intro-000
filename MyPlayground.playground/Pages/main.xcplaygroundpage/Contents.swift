 ...
 */
func whatsMyFaveMusic () {
    let faveMusic = "Trance and techno."
    print(faveMusic)
}
...
func greet(name: String) {
    print("Buenas, \(name). Fue un placer conocerte.")
}
