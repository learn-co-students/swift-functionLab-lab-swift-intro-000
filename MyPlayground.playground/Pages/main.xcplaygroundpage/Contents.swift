...
func myName(name: String) {
    print("What's up! My name is \(name), and I like to party.")
}
myName(name: "Shane")
myName(name: "Chuck")
myName(name: "Franky Diesel")
...
func favoriteFood(){
    var foodType = "pizza"
    print("I really love \(foodType).")
    foodType = "chinese"
    print("My favorite type of food is \(foodType).")
}
favoriteFood()
