...
helloPerson(name: "Beate")
helloPerson(name: "Traude")
helloPerson(name: "Germany")
 ...
 */
var aName = "Nicole"
helloPerson(name: aName) //The variable replaces the name parameter with the value that was passed into the variable

aName = "Jithin"
helloPerson(name: aName) //The changed variable value takes the place of 'name' variable. Cool!
