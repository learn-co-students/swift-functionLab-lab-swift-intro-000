 ...
 */
func helloHuman(name: String) {
    print("Hello, Human \(name)")
}

helloHuman(name: "Hugo")
 ...
 */
let nameconstant = "Constant Hugo"
helloHuman(name: nameconstant)

var everchangingname = "Hugo v.1"
helloHuman(name: everchangingname)

everchangingname = "Hugo v.2"
helloHuman(name: everchangingname)
