 ...
 */
func coffeeBreak() {
    let favoriteCoffeeShop = "Starbucks"
    print("Let's go to \(favoriteCoffeeShop).")
 ...
 */
func sayWassup (Name: String) {
    print ("Wassup \(Name), what have you been up to?")
}
