 ...
 */
func dispalyGreeting (name: String){
    
    print("Hello, \(name)")
}
dispalyGreeting(name: "Ramunas")
dispalyGreeting(name: "Jonas")
dispalyGreeting(name: "Saulius")
 ...
 */
let personName = "Gediminas"

dispalyGreeting(name:personName)
