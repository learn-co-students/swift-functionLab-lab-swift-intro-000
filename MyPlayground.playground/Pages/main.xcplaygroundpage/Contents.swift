...
func greeting(name: String){
    print("Hey, \(name) you jerky jerk!")
}

greeting(name: "Charles")
greeting(name: "Monkey Man")
greeting(name: "Chunky Cheese")
 ...
 */
let coolGuy = "Cool Guy"
greeting(name: coolGuy)
...
func printVariable(variable: String){
    print(variable)
}
