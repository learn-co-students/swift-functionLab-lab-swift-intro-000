 ...
 */
// write your code here
func sample(decValue: String){
    let yeah = decValue
    print(yeah)
}
sample(decValue: "yehey")
 ...
 */
// write your code here
var personName = "sample name"
person(name: personName)
personName = "sample name 2"
person(name: personName)
 ...
 */
// write your code here
func sample5(decValue1: String){
    var yeah = decValue1
    print(yeah)
    yeah = "kamehamewave"
    print(yeah)
}
sample5(decValue1: "goku")
sample5(decValue1: "gohan")
