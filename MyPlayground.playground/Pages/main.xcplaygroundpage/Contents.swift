 ...
 */
func myFunction() {
    let waterBottle = "plastic"
    print("All water bottles should be \(waterBottle).")
}
myFunction()
...
personName(name: "Ethan")
personName(name: "Trickster")
personName(name: "Joker")
personName(name: "Ozai")
...
func favProd() {
    var prod = "iPhone 5"
    print("My favorite Apple product is the \(prod).")
    prod = "iPad Pro"
    print("My favorite Apple product is the \(prod).")
}
favProd()
