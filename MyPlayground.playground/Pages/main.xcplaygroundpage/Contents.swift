...
// write your code here
func whatConstant() {
    let solutionsToTheUnivers = 42
    print(solutionsToTheUnivers)
}
whatConstant()
/*: question3
...
func depositMoney(balance: Int){
    var balanceAmount = 0
    print("Your Beginning Balance: \(balanceAmount)")
    balanceAmount = balanceAmount + balance
    print("Your New Balance: \(balanceAmount)")
}
depositMoney(balance: 50)
depositMoney(balance: 3200)
depositMoney(balance: 50000)
