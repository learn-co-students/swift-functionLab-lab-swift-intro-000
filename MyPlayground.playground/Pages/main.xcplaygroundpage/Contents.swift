...
func person(name:String) {
    ...
    print("Hey \(name)! How are you doing today \(name)? I am doing well myself. Have a nice day, \(name)!")
    
}

person(name: "Charissa")
person(name: "Taylor")
person(name: "Daisy")
person(name: "Jamie")
