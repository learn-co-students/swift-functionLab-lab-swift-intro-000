...
greetPerson(name: "Johnny")
greetPerson(name: "Navpreet")
greetPerson(name: "Riwaaz")
/*: question4
...
func greetPrez() {
    var prez = "Bush"
    print("President \(prez) is a buffoon.")
    prez = "Trump"
    print("President \(prez) is a buffoon.")
}
