...
func greetings(name:String){
    print("Hope all is well today \(name)!")
}
...
//Aruguements just changes the greetings name
 ...
 */
    var favoriteCharchter = "Tyrion"
    greetings(name: favoriteCharchter)
    favoriteCharchter = "Ned Stark"
    greetings(name: favoriteCharchter)

    //Will update as var changes but function must be called again to see visible print statement change
...
//Addition print , as x or y change and gets called the adder function prints out the sum
