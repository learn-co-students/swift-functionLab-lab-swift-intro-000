 ...
 */
// Using a variable that I declared as argument in the function will print the greeting with the name that I assigned to that variable.

var personName = "Monica"

greeting(name: personName)

// After changing the value of that variable, I will see the greeting with the new name that I've assigned ti it.
 ...
 */
// I expect to have both 'prints' printed in the consule, for the first var declared and also for the new value assigned to it.
