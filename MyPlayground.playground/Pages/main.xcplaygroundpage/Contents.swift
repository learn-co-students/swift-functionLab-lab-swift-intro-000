...
func person(name: String) {
    let greeting = "Good morning, \(name), how are you?"
    print(greeting)
}
...
//What I'll see in the console is the greeting printed, however I'll see the name different each time a different argument is passed in.
...
//What I see in the console is that when the variable is passed in with the function call, the console prints out what was contained in the variable in the phrase.
