 ...
 */
// write your code here
func personsGreeting(name: String) {
    print("Hi, my name is \(name)!")
}

personsGreeting(name: "John Doe")
personsGreeting(name: "Jane Doe")
personsGreeting(name: "Roel Cantu")
 ...
 */
// write your code here
// GETTING ERRORS WHEN PASSING A VARIABLE AS AN ARGUMNT.
