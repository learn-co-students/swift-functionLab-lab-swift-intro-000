...
func nameCalling(name: String) {
    print("Hey \(name), it's so nice to meet you!")
}

nameCalling(name: "Emma")
nameCalling(name: "Dana")
nameCalling(name: "Mozzie")
/*: question4
...
func decVar() {
    let varOne = "Variable One to the Rescue!"
    print(varOne)
    let varTwo = "Variable Two to the Rescue!"
    print(varTwo)
}
