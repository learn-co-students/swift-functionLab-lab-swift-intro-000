 ...
 */
func printConstant() {
  let funcConstant = "Hello, constant!"
...
printGreeting(name: "Joe")
printGreeting(name: "Alison")
 ...
 */
func changedPrinting() {
  var textToPrint = "First round"
  print(textToPrint)
  
  textToPrint = "Second round"
  print(textToPrint)
}
