 ...
 */
func printConstant() {
    let constantTextToPrint = "This is a constant text"
    print (constantTextToPrint)
}
...
func greetPerson (name: String) {
    print("Hi there, \(name). How are you doing today?")
}

greetPerson(name: "Jon")
greetPerson(name: "Jane")
greetPerson(name: "Tom")
greetPerson(name: "Sarah")
 ...
 */
let constantPersonName = "Will"
greetPerson(name: constantPersonName)
var personName = "Robert"
greetPerson(name: personName)
personName = "Mary"
greetPerson(name: personName)
 ...
 */
func printSeveralNamesWithInnerVariable () {
    var personName = "Jim"
    print(personName)
    personName = "Lara"
    print(personName)
...
printSeveralNamesWithInnerVariable()
printSeveralNamesWithInnerVariable()
printSeveralNamesWithInnerVariable()
