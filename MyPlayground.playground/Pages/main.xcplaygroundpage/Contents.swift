 ...
 */
func davidsFuncion() {
    let partyHard = "Always party hard"
    print("My advice to you: \(partyHard)")
}
 ...
 */
func thisOldDog(name: String) {
    print("What's up, \(name)?")
}

thisOldDog(name: "Mac")
thisOldDog(name: "Peter Piper")

let name2 = "Thomas"

thisOldDog(name: (name2))
 ...
 */
func partyStarter() {
    var firstIngredient = "vodka"
    print("First thing we need is \(firstIngredient)")
    firstIngredient = "juice"
    print("But obviously, we also need \(firstIngredient)")
}
