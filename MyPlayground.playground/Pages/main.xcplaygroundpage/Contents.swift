 ...
 */
func myName() {
    let name: (String) = "Emiko Murakami"
...
func myAge() {
    var ageThisYear = 45
    ageThisYear = 46
    print("My age this year is \(ageThisYear).")
}
myAge()
myAge()
myAge()
//The last variable's value is applied to all the function you called because the variable was modified inside the function.
