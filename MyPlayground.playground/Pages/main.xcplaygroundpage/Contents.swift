...
helloPerson(name: "Kevin")
helloPerson(name: "Mitzy")
 ...
 */
func random() {
    var email = "kev.0587@gmail.com"
    print("Your email is: \(email)")
    
    email = "kcollins19875@gmail.com"
    print("Your email is now: \(email)")
}
