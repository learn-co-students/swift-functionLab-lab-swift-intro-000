 ...
 */
func fuckOff(name: String) {
    print("Fuck off \(name) and leave me alone!")
}
 ...
 */
var kingdomHearts = "Sora"

fuckOff(name: kingdomHearts)

var kingdomHeartsVillain = "Riku"

fuckOff (name: kingdomHeartsVillain)
...
func fuckYou() {
    var names = "Tina"
    print("Fuck you \(names), leave me alone!")
    names = "Gerald"
    print("Fuck you \(names), leave me alone!")
}
