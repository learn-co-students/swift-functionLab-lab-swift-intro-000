 ...
 */
var humanName = "Courtney"
hello(name: humanName)


// once calling the variable I called the function and put the variable name in the argument and it returned that name
...
// after calling the function as expected I saw both of the variables printed to the console everyttime, so I called it twice and saw it each time print the variables - which prnted 4 numbers.
