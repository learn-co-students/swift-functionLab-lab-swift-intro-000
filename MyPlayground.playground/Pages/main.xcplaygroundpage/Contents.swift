 ...
 */
// write your code here
func personsName(theName: String){
    print("Greetings \(theName)")
    
}

personsName(theName: "Dasani")
personsName(theName: "Peter")
...
// write your code here
let theName1 = "Brian"
personsName(theName: theName1)

var theName2 = "chad"
personsName(theName: theName2)
theName2 = "Muhammad"
personsName(theName: theName2)
...
func flavorDrink(){
    var drink = "Pepsi"
    print("I would like an ice cold \(drink)")
    drink = "Sprite"
    print("I would like an ice cold \(drink)")
}
