...
func GivemeMoney()
{
    let Solicitar : String = "Bla Bla Bla"
    print(Solicitar)
}
GivemeMoney()
...
let DiHola: String = "Hello \(name)! How are you doing?"
    print(DiHola)
}
greeting(name: "Esmerlin Moya")
...
var nameOfPerson: String = "dont know"
