 ...
 */
func favoriteRudiment() {
    let rudiment = "My Favorite rudiment is a paradiddle"
    print(rudiment)
...
func greeting(name: String) {
    let greeting = "Hey \(name), whats up?"
    print(greeting)
}
 ...
 */
func vacation() {
    var vacationType = "on a Cruise"
    print("we are going \(vacationType)")
    vacationType = "To Florida"
