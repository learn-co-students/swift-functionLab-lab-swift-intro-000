 ...
 */
let name="Sarah"
greetNamed(name: name)
var currentName="Jeff"
greetNamed(name: currentName)
currentName="Robert"
greetNamed(name: currentName)  // all worked as I expected
...
myfunc2()
myfunc2()
myfunc2()  // see 1 then 2 printed each time. this is correct and what's expected: myvar initialized anew each time function called
