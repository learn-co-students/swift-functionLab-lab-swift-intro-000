...
func myFunc() {
    let str: String = "This is constant"
    print(str)
}
myFunc()
 ...
 */
// write your code here
func takePersonsNameAndPrintGreeting(personName: String) {
    print("Greetings \(personName)!")
}
takePersonsNameAndPrintGreeting(personName: "Jose")
takePersonsNameAndPrintGreeting(personName: "Joshua")
takePersonsNameAndPrintGreeting(personName: "Matthew")
...
// write your code here
var name = "William"
takePersonsNameAndPrintGreeting(personName: name)
