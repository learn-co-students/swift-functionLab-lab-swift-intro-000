 ...
 */
func personalGreeting(person: String) {
    print("Hello \(person), how are you?")
}

personalGreeting(person: "Jeremy")

personalGreeting(person: "Charlie")

personalGreeting(person: "Adam")
 ...
 */
let boyName = "Zac"
personalGreeting(person: boyName)

var girlName = "Sally"
personalGreeting(person: girlName)
girlName = "Sarah"
personalGreeting(person: girlName)
