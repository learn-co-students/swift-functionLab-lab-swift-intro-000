...
// write your code here
func grootTalks() {
  let grootsStatement = "I am Groot"
  print(grootsStatement)
}
 ...
 */
// write your code here
func niceComment(name: String) {
  print("\(name) is really nice!")
}

niceComment(name: "Thor")

niceComment(name: "Bill")

niceComment(name: "Jessica")
 ...
 */
// write your code here
//I expect to see an error of some sort...
let name = "Jeff"

niceComment(name: name)

var name2 = "Ashley"

niceComment(name: name2)
...
func printVariable(number: Int) {
  print("I have $\(number) in my bank account")
}

printVariable(number: bankAccountBalance)
