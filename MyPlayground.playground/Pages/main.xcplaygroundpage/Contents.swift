 ...
 */
func keyboardTyper(person:String) {
    print("My name is \(person) and I am a keyboard typer! Hear me roar.")
}

keyboardTyper(person: "Mike")
keyboardTyper(person: "Jon")
...
func iphone() {
    var phoneMan = "Bob"
    print("Hello. My name is \(phoneMan) and I like iPhones.")
