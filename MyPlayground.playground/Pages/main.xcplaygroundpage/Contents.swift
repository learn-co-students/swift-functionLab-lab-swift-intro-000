 ...
 */
func callYouMaybe(name: String) {
    print("Greetings to you, \(name)!")
}

callYouMaybe(name: "Joe")
callYouMaybe(name: "Sarah")
callYouMaybe(name: "Evan")
 ...
 */
let hisName = "Kevin"
callYouMaybe(name: hisName)


var herName = "Kristin"
callYouMaybe(name: herName)
 ...
 */
func suppliesNeeded() {
    var supplyName = "Pencils"
    print(supplyName)
    supplyName = "Calculators"
    print(supplyName)
}
