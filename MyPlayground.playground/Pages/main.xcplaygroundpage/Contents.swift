 ...
 */
func personFunction(name: String){
    print("Hello \(name)!")

}


personFunction(name: "Imtiaz")


personFunction(name: "Shamsul")
 ...
 */
var personName = "Imtiaz"

personFunction(name: personName)
