 ...
 */
func iceCream() {
    let hungry = "Give me ice cream now!"
    print(hungry)
}
 ...
 */
func myFriend(friendsName: String) {
    print("This is my friend, \(friendsName)!")
}

myFriend(friendsName:"Dennis")

myFriend(friendsName: "Charles")
 ...
 */
let friendsName = "Pete"
myFriend(friendsName: friendsName)
 ...
 */
func superMarket() {
    let badFood = "I'm going to buy Junk food!"
    print(badFood)
    let goodFood = "I'm going to buy healthy food!"
    print(goodFood)
}
