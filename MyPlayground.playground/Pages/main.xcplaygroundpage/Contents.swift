...
// write your code here
func pickabagel() {
    let onion = "chicken cheese fries with bacon"
    print("hello sir would you like \(onion) on that?")
}
pickabagel()
...
func greeting(name: String) {
    print("TOP OF THE MORNING TO YA \(name)")
}
greeting(name:"SHERYL")
greeting(name:"GUNTHER")
 ...
 */
// write your code here
let thetruckdriver = "Rowdy Rodny Piper"
greeting(name:thetruckdriver)

var thebusdriver = "Ol Betsy"
greeting(name:thebusdriver)
