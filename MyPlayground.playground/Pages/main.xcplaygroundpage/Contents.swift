 ...
 */
func printConstant() {
    let myConstant = "Yo, I'am a constant!"
    print(myConstant)
}
...
greet(personName: "Gob")
greet(personName: "Buster")
greet(personName: "Tobias")
 ...
 */
let detective = "Gene Parmesan"
greet(personName: detective)

var person = "Mike Smith"
greet(personName: person)
person = "Mike Smith Jr."
greet(personName: person)
...
//since this variable only exists in the scope of the function, everytime it is called, arg1 is initialized with Test and then has its value changed
