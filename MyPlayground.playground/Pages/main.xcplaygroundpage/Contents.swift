 ...
 */
func printConstant() {
    let constant = "This string can never be mutated!"
    print(constant)
}
 ...
 */
func personalGreeting(_ name: String) {
    print("Hello, \(name)!")
}

personalGreeting("Erica")
personalGreeting("Sammy")
personalGreeting("Quincy")
/*: question4
