 ...
 */
func pet () {
    let myPet = "My pet's name is Clara"
    print(myPet)
}
 ...
 */
let firstFriend = "Alex"
var secondFriend = "Jane"

hello(name: firstFriend)
hello(name: secondFriend)
 ...
 */
func numberOfFriends() {
    var number = 5
    print("I've got \(number) friends")
    number = 10
    print("I've got \(number) friends")
}
