 ...
 */
func strangerGreeting(name: String) {
    
    print("\(name)! What's up?!")
    
}

strangerGreeting(name: "Dawg")
strangerGreeting(name: "Foo")
strangerGreeting(name: "Jerkface")


/*: question4
 ### 4. Now call the function you wrote in Question 3 using a variable or constant instead of a string literal. What do you expect to see in the console? Try passing in a _variable_ you declared (using `var`) as an argument. Then change that variable's value and call your function again. What do you see in the console?
 */
var insult = "Poopface McGee"

strangerGreeting(name: insult)
...
func funVideoGames() {
    ...
    var bestVideoGame = "Gears of War"
    print(bestVideoGame)
    bestVideoGame = "BF1"
    print(bestVideoGame)
}
