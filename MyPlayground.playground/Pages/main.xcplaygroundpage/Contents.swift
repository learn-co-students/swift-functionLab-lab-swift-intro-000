 ...
 */
func myOwnFunction() {
  let myConstant: String = "This is my function!"
  print(myConstant)
}
...
greeting(person: "Harry")
greeting(person: "Alexander")
greeting(person: "Julia")
...
for name in ["Harry", "Julia", "Sanja", "Paul", "Peter"] {
