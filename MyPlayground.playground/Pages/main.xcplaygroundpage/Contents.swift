...
func aboutMe() {
    ...
    let name = "Matt"
    let areaFrom = "North Wales"
    let tempNow = 1
    print ("My name \(name) is and I am from \(areaFrom). The temperature today feels like \(tempNow)")
...
helloPerson(name: "Matt")
helloPerson (name: "James")
/*: question4
...
let name1 = "Matty"
helloPerson(name: name1)
let name2 = "Gareth"
helloPerson(name:name2)
