 ...
 */
func personalGreetingMatt() {
    print("Hi Matt, Welcome!")
}
func personalGreetingTerry() {
    print("Hi Terry, Welcome")
}
func personalGreetingLaraine() {
    print("Hi Laraine, Welcome")
}
personalGreetingMatt()
personalGreetingTerry()
personalGreetingLaraine()

/*: question4
 ### 4. Now call the function you wrote in Question 3 using a variable or constant instead of a string literal. What do you expect to see in the console? Try passing in a _variable_ you declared (using `var`) as an argument. Then change that variable's value and call your function again. What do you see in the console?
 */
func personalGreeting2(name: String) {
    print("Hi \(name), Welcome!")
}
personalGreeting2(name: "Terry")
personalGreeting2(name: "Matt")
personalGreeting2(name: "Laraine")
