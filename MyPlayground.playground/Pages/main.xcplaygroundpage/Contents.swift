 ...
 */
func houseHoldMembers(name: String){
    print("Welcome home, \(name)")
}
houseHoldMembers(name: "Gia")
houseHoldMembers(name: "Kuba")
 ...
 */
var girlDogName = "Trish"

houseHoldMembers(name: girlDogName)
 ...
 */
func dinner(){
    var tonightsDinner = "Chicken Soup"
    print("Tonight we are having \(tonightsDinner).")
    tonightsDinner = "Salad"
    print("Or we can eat \(tonightsDinner).")
}
