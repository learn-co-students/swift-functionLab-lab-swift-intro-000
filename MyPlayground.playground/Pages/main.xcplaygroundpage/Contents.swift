 ...
 */
func personsName(name: String) {
    print("Hello \(name), how are you today?")
    
}

personsName(name: "Steve")
personsName(name: "Hanna")
personsName(name: "Joey")
...
personsName(name: nameOfMe)

var nameOfYou = "Bob"

personsName(name: nameOfYou)
...
func declareVariable (){
    var happyHappy = "Happy Happy, Joy Joy!"
    print (happyHappy)
    happyHappy = "Joy Joy, Happy Happy!"
    print (happyHappy)
}
