 ...
 */
func iLikeGirls() {
    let foreverGirls: String = "Girls have something special in common!"
    print(foreverGirls)
}
iLikeGirls()
/*: question3
...
greet(name: "Roger")
greet(name: "Bernadette")
greet(name: "Claudette")

/*: question4
 ### 4. Now call the function you wrote in Question 3 using a variable or constant instead of a string literal. What do you expect to see in the console? Try passing in a _variable_ you declared (using `var`) as an argument. Then change that variable's value and call your function again. What do you see in the console?
 */
let favoriteTennisPlayer = "Roger Federer"
var favoriteSoccerPlayer: String = "Lionel Messi"
greet(name: favoriteTennisPlayer)
greet(name: favoriteSoccerPlayer)
