 ...
 */
// write your code here
func greetingToName(name: String){
    print("Hello there \(name)")
}
greetingToName(name: "Phil")
greetingToName(name: "Jonah")
greetingToName(name: "Erik")
 ...
 */
// write your code here
var nameOfPersonToGreet = "Phil"
greetingToName(name: nameOfPersonToGreet)
