...
func greeting(personName: String) {
    print("Hello, \(personName), How are you doing this very fine day?")
}

greeting(personName: "John")
greeting(personName: "Jake")
greeting(personName: "Edd")
