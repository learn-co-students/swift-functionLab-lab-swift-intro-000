 ...
 */
func myFunction() {
    let newStatement = "This is me declaring a constant inside the function's body!"
    print(newStatement)
}
...
func greeting(name: String) {
    print("Buenas dias, \(name)!")
}

greeting(name: "Mike")
greeting(name: "Daniellas")
greeting(name: "mi amigo")
 ...
 */
func myPhone() {
    var phoneType = "iPhone 6s"
    print("I had an \(phoneType)")
    phoneType = "iPhone 7"
    print("But I just upgraded to the new \(phoneType)")
}
