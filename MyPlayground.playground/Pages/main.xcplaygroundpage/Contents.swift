 ...
 */
func bookWorm() {
    print("I'm reading the Hidden Life of Trees. What are you reading?")
}
bookWorm()
...
helloFriend(name: "Bibi")
helloFriend(name: "Sophie")
helloFriend(name: "Andy")
helloFriend(name: "Rena")
 ...
 */
var pal = "Rena"
helloFriend(name: pal)
let pal2 = "Sophie"
helloFriend(name: pal2)
