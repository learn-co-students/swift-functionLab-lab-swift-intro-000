 ...
 */
func myFirst() {
    let greeting: String = "Hi, babe! How's your day going?"
    print(greeting)
}
 ...
 */
// I expect to see an error if I put in an Int, but should work fine if I put in a String
 ...
 */
func shitHappens(){
    var sandwich = "lemon squeeze"
    print("\(sandwich) is random.")
    sandwich = "ramen"
    print("\(sandwich) is super random.")
}
