...
// write your code here
func passSalt() {
    let request: String = "Can you please pass the salt?"
    print(request)
}
passSalt()
...
func greeting(name: String) {
    let sayHello: String = "Hello \(name)! How are you doing?"
    print(sayHello)
}
greeting(name: "Harold")
 ...
 */
// write your code here
var nameOfPerson: String = "Lucy"
greeting(name: nameOfPerson)
