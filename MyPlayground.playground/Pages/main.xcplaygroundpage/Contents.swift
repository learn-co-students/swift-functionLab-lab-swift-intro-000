 ...
 */
func createGreeting(name: String) {
    print("Hello \(name), how are you doing?")
}

createGreeting(name: "Sam")
createGreeting(name: "Veronica")
createGreeting(name: "Beth")
...
// you would expect to see the numbers repeated
