 ...
 */
func saySomething(){
    let something: String = "I wanna say something!!"
    print(something)
}
saySomething()
...
func greeting(name: String){
    print("Nice to see you, \(name). How are you?")
}
greeting(name: "John")
greeting(name: "Paul")
greeting(name: "Julia")
 ...
 */
func myFunction(){
    var myVariable: String = "Peter"
    print("Hellor \(myVariable)")
    myVariable = "Jefferson"
    print("Hellor \(myVariable)")
}
myFunction()
myFunction()
