...
func congratsToPet(name:String)
{
    print("Congrats to \(name)")
}

congratsToPet(name: "Abadon")
congratsToPet(name: "Spider")
congratsToPet(name: "Venom")
...
var petName = "antman"
congratsToPet(name: petName)

let name1 = "mike"
congratsToPet(name: name1)

var name2 = "test"
congratsToPet(name: name2)
name2 = "test2"
congratsToPet(name: name2)
