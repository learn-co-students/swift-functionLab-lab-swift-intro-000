 ...
 */
func myBeautifulWife() {
    let wife = "Leleth"
    print("My wife is \(wife).")
}
...
personName(name: "George")
personName(name: "Ging")
...
func shoes() {
    var newShoes = 5
    print("I bought \(newShoes) new shoes, and now I am broke")
    newShoes = 3
    print("I bought \(newShoes) new shoes, and I am not broke")
}
