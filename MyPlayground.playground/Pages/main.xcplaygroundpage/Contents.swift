...
greetings(name: "Marie")
greetings(name: "Quentin")
greetings(name: "Stanislas")
 ...
 */
func myOwnOtherFunction() {
    var firstVariable = "FirstVar"
    print("Voici \(firstVariable)")
    firstVariable = "AnotherVar"
    print("Voici \(firstVariable)")
}
