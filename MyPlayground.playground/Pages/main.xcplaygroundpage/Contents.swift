...
nameOfPerson(name: "John")
nameOfPerson(name: "Nik")
nameOfPerson(name: "Bob")
 ...
 */
let name1 = "Nik"
nameOfPerson(name: name1)

var name2 = "John"
nameOfPerson(name: name2)
name2 = "Bob"
nameOfPerson(name: name2)
...
func carSlogan() {
    var car = "BMW"
    print ("\(car) is the Ultimate Driving Machine")
    car = "Ford"
    print ("\(car) is the Ultimate Driving Machine")
}
