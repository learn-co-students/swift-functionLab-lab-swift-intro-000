 ...
 */
func requestHelp(location: String) {
    print ("SOS! We are stuck \(location)!")
}
requestHelp(location:"on a desert island")
requestHelp(location:"in a dark cave")
requestHelp(location:"in the deepest jungle")
requestHelp(location:"on the highest mountaintop")
