 ...
 */
// write your code here
func printGreetingFor(user: String) {
    print("It's nice to see you \(user)")
}
printGreetingFor(user: "Chris")
printGreetingFor(user: "Adam")
printGreetingFor(user: "Sandy")
