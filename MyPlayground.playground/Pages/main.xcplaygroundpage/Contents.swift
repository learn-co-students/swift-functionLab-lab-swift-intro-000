...
func monsters() {
    let monster = "Fred"
    print("the current monster is \(monster)")
}
 ...
 */
// write your code here
func helloPeople(name: String){
    print("Hello, \(name)")
}

helloPeople(name: "Sandy")
helloPeople(name: "Frank")
helloPeople(name: "Migos")
helloPeople(name: "Jhony")
/*: question4
 ### 4. Now call the function you wrote in Question 3 using a variable or constant instead of a string literal. What do you expect to see in the console? Try passing in a _variable_ you declared (using `var`) as an argument. Then change that variable's value and call your function again. What do you see in the console?
 */
// write your code here
var person = "Joey"
helloPeople(name: person)
person = "Angel"
helloPeople(name: person)
...
func tests() {
    var thing = "Momunji"
    print("The test concluded in \(thing)")
    thing = "Golumga"
    print("The second test concluded in \(thing)")
}
tests()
tests()
tests()
