 ...
 */
// write your code here
func helloGreeting(personName: String){
    print("hello \(personName)")
}

helloGreeting(personName: "Mark")
helloGreeting(personName: "janet")
 ...
 */
// write your code here
//var  nameOfPerson = "James"
var  nameOfPerson = "Andy"
helloGreeting(personName: nameOfPerson)

// chaning the value of nameOfPerson variable will pass the updated value as an argument to the helloGreetings function
...
mammalsNames()
mammalsNames()
// Everytime i call this functionit is going to print variable and it updated values.
