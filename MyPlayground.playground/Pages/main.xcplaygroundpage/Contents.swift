 ...
 */
func favouriteBook (){
    let bestBookEver = "The Name of the Wind"
    print (bestBookEver)
}
favouriteBook()
 ...
 */
func salutations (name: String) {
    print ("Hello \(name)!")
}
salutations("Crystal")
salutations("Kvothe")
salutations("Diana")
salutations("Lysistrata")
salutations("Ada")
...
// the variable is inside the scope of the function and therefore cannot be changed outside of the function. I expect to see errors
