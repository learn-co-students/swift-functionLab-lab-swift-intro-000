...
func someContant()
{
    let aConstant = "This data is stored inside a constant"
    print(aConstant)
}
...
{
    var someData = "A string existing within a container"
    print(someData)
    
    someData = "I changed the string, woops!"
    print(someData)
}
