 ...
 */
func sayGreetingTo(name: String) {
  print("Welcome to my world, \(name). Behave.")
}

sayGreetingTo(name: "Tom")
sayGreetingTo(name: "Sally")
sayGreetingTo(name: "Martin")
