...
func printConstant()
{
    let myConstant = "This is a constant string value."
    print(myConstant)
}
 ...
 */
func greetPeople(firstName: String){
    print("Greetings \(firstName), how was your evening?")
}

greetPeople(firstName: "George")
greetPeople(firstName: "Bill")
greetPeople(firstName: "Ron")


/*: question4
 ### 4. Now call the function you wrote in Question 3 using a variable or constant instead of a string literal. What do you expect to see in the console? Try passing in a _variable_ you declared (using `var`) as an argument. Then change that variable's value and call your function again. What do you see in the console?
 */
let myFirstName = "Anthony"

greetPeople(firstName: myFirstName)
...
func doCoolStuff()
{
    var myCoolVariable = "Darth Vader"
    print(myCoolVariable)
    
    myCoolVariable = "Anakin Skywalker"
    print(myCoolVariable)

    myCoolVariable = "Luke Skywalker"
    print(myCoolVariable)

    myCoolVariable = "Leia Skywalker"
    print(myCoolVariable)
    
    myCoolVariable = "Obe Wan Kenobe"
    print(myCoolVariable)
}
