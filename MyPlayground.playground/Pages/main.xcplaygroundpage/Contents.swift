...
greeting(name: "Chelsea")
greeting(name: "Paul")
greeting(name: "Lauren")

// It will print 3 separate greetings with each name
/*: question4
...
// It will print a greeting with Angelo and one with Dave
// It will print a greeting with Aaron
/*: question5
...
// It will print both song titles each time the function is called
