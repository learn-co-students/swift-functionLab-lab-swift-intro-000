 ...
 */
func myFunction(){
    let countOfPlanets = 9
    print(countOfPlanets)
}
myFunction()
 ...
 */
func autoGreeting(name:String)
{
    print("Hi \(name), Hope you had a great day")
}

autoGreeting(name: "John")
autoGreeting(name: "Brian")
autoGreeting(name: "Neville")
 ...
 */
var bestFriend = "Julia"

autoGreeting(name: bestFriend)
