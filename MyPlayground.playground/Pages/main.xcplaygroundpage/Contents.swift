 ...
 */
func heyFriend(name:String){
    
    print("Hey, \(name)!")
    
}

heyFriend(name: "Marry")
/*: question4
...
func heyFriendTwo(name:String){
    print("Hey, \(name)!")
}

heyFriendTwo(name: nameOne)
heyFriendTwo(name: nameTwo)
...
//the variable age used in the function cannot be used outside of the function!
