 ...
 */
func thisConstant(){
    let constant = "I am printing to the console!"
    print(constant)
}
thisConstant()
...
func personGreeting(person: String){
    ...
    print("Hello \(person), nice to meet you!")
}

personGreeting(person:"Chloe")
personGreeting(person:"Robert")
personGreeting(person:"Chester")
personGreeting(person:"Mary")
/*: question4
 ### 4. Now call the function you wrote in Question 3 using a variable or constant instead of a string literal. What do you expect to see in the console? Try passing in a _variable_ you declared (using `var`) as an argument. Then change that variable's value and call your function again. What do you see in the console?
 */
let name1 = "Chloe"
personGreeting(person: name1)

var name2 = "Robert"
personGreeting(person: name2)
 ...
 */
func myFunction(){
    var type = "This is my type"
    print(type)
    type = "This is my new type"
    print(type)
}
myFunction()
myFunction()
