...
func namedGreeting(name: String) {
    print ("Hello there \(name), are you ok ?")
}

namedGreeting(name: "Robin")
namedGreeting(name: "Karen")
namedGreeting(name: "Jessica")
