 ...
 */
func greetingCall(name: String) {
    print("Hello \(name), how are you doing on this fine day?")
}

greetingCall(name: "Tech N9ne")
greetingCall(name: "TJ Schoost")
greetingCall(name: "Chase")
