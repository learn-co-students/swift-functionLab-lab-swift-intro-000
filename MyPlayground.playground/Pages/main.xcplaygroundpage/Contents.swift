...
func greeting(name: String) {
    print("G'day \(name), how are you this fine Australian morning?")
}

greeting(name: "Anna")
greeting(name: "Daryl")
greeting(name: "Viennci")
 ...
 */
var newFriend = "Michael"
greeting(name: newFriend)
