 ...
 */
func printConst() {
    let myConst: String = "My constant text"
    print(myConst)
}
 ...
 */
func nameMessage(name: String) {
    print("Hello \(name), how you doin'?")
}

nameMessage(name: "Tony")

nameMessage(name: "Bill")

nameMessage(name: "Audry")


/*: question4
 ### 4. Now call the function you wrote in Question 3 using a variable or constant instead of a string literal. What do you expect to see in the console? Try passing in a _variable_ you declared (using `var`) as an argument. Then change that variable's value and call your function again. What do you see in the console?
 */
var nameString: String = "Hillary"
nameMessage(name: nameString)
...
func lastFunction() {
    ...
    var generalTwo = general
    print("generalTwo = \(general)")
}
