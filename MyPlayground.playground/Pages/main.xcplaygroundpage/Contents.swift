...
// write your code here
func printGreetings() {
    let greeting = "Greetings and salutations"
    print(greeting)
}
 ...
 */
// write your code here
func customizedGreeting(name:String) {
    print("Hello \(name)")
}

customizedGreeting(name: "Larry")
customizedGreeting(name: "Moe")
customizedGreeting(name: "Curly")
