 ...
 */
//expect to see the greeting with the constant value
let newConst = "Some string"
greeting(name: newConst)
var newVar = "Some var"
greeting(name: newVar)
newVar = "new var value"
greeting(name: newVar)
//the greeting changed to the new variable value
 ...
 */
func newFunc() {
    var funcVar = "hey there"
    print(funcVar)
    //do you mean assign it a new value not new variable?
    funcVar = "bye now"
    print(funcVar)
}
newFunc()
