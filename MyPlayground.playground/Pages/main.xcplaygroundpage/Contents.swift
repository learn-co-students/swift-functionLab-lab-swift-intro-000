 ...
 */
func yourHairColor(color: String) {
    print("Hello, \(color)!")
}

yourHairColor(color:"Red")
yourHairColor(color:"Blue")
yourHairColor(color:"Yellow")
yourHairColor(color:"White")
 ...
 */
let color1 = "Pink"
yourHairColor(color:color1)

var color2 = "Black"
yourHairColor(color:color2)
