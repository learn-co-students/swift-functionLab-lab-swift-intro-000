 ...
 */
func name(friend: String) {
    
    
    
    print("Hi \(friend), how's it going?")
    
    print("Go home \(friend)!")
...
func score() {
    ...
    print("The score is \(winner) to nothing")
    
    winner = 2
    
    print("The score is now \(winner) to nothing")
}
