...
greetingPerson(name : "Vasya")
greetingPerson(name : "Petya")
greetingPerson(name : "Kolya")
...
let svetaName  = "Sveta"
var personName = "Lena"
greetingPerson(name : svetaName)
greetingPerson(name : personName)
personName = "Anna"
greetingPerson(name : personName)
