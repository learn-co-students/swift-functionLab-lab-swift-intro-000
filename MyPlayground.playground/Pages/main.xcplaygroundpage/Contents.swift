 ...
 */
func nerdfighter() {
    let DFTBA = "Don't Forget to Be Awesome"
    print(DFTBA)
}

"As we say in my hometown, \(nerdfighter())!"
...
greetName(name: "Rain")
greetName(name: "Luciana")
greetName(name: "Belén")
 ...
 */
func pizzaToppings(topping: String) {
    var favoriteTopping = "mushrooms"
    print("My favorite pizza topping is \(favoriteTopping), but I like \(topping) too.")
    favoriteTopping = "spinach"
    print("My favorite pizza topping is \(favoriteTopping), but I like \(topping) too.")
}

pizzaToppings(topping: "spinach")
pizzaToppings(topping: "tomatoes")
pizzaToppings(topping: "cheese")
