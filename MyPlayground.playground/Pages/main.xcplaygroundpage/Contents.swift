 ...
 */
func printCons(){
let myConstant = "This is a string constant"
print(myConstant)
}
printCons()
 ...
 */
func myGreetings(name:String){

    print("Hello \(name), Welcome to my World")
}
myGreetings(name: "Surendar")
myGreetings(name: "Raja")
myGreetings(name: "Vasanth")
...
myGreetings(name: userName)
userName = "Santhosh Ramakrishnan"
myGreetings(name: userName)
...
func printMultiple(){
var myFriend = "Suresh"
    print("Now my friend is \(myFriend)")
    myFriend = "Simon"
    print("From now on My friend is \(myFriend)")
