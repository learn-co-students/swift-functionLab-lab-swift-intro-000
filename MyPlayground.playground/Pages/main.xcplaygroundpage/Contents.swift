 ...
 */
// write your code here
func funtionWithArgument(name: String) {
    print("Hello \(name)");
}

funtionWithArgument(name: "Kings Landing")
funtionWithArgument(name: "Drogonstone")
...
// write your code here
var name1 = "John Snow"
let name2 = "Arya Stark"

funtionWithArgument(name: name1)
funtionWithArgument(name: name2)
 ...
 */
// write your code here
func funtionWithVariable() {
    var motto = "Winter is Coming!";
    print(motto);
