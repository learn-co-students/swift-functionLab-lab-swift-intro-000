...
func helloFriend(name: String) {
    print("Hey there, \(name), how ya been?")
}

helloFriend(name: "Evan")
helloFriend(name: "Mike")
helloFriend(name: "Nathan")
 ...
 */
let fatBoy = "Alfie"
helloFriend(name: fatBoy)

var name2 = "Chloe"
helloFriend(name: name2)
name2 = "Billy"
helloFriend(name: name2)
...
func partySpot() {
    var myHometown = "STL"
    print("Howdy, the party is in \(myHometown)")
    myHometown = "Dallas"
    print("Howdy, the party is in \(myHometown)")
