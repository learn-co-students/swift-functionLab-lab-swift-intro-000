 ...
 */
func nameAndGreeting(name: String){
    print("Hello \(name), what a lovely day!")
}

nameAndGreeting(name: "Nathaniel")
nameAndGreeting(name: "Mom")
...
nameAndGreeting(name: izName)
nameAndGreeting(name: sisName)
nameAndGreeting(name: foodType)
