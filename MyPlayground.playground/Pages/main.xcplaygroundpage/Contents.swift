 ...
 */
func argName(name: String) {

    print("Hello \(name), what are you up to today?")
}
...
// I Should see the function change the name as the name applies to the sentence.
...
argName(name: hope)
 // should print my var "hope" in the console. 

hope = "Lost"

argName(name: hope)

// should show my variable printed as "Lost" now.
...
func smart() {
    ...
    var test = "what is a tootsie pop?"
    
    print(test)
    
    test = "a lollipop, with a tootsie roll center."
    
    print(test)
}

// I expect my function to keep printing in order of variable and strings set.
