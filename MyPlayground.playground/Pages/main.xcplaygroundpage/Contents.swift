...
// write your code here
func soccerGame() {
    let firstGoal = "Germany"
    print("The first goal was made by \(firstGoal).")
}
...
func greetings(name: String) {
    print("Hey \(name), I haven't seen you in a while.")
}

greetings(name: "Leena")
greetings(name: "Juan")
 ...
 */
// write your code here
// expect to see an error because if I assigned \(name) to be a String it will not let me enter another data type in it place.
var sampName = "Charmander"
greetings(name: sampName)
