 ...
 */
func testFunk(fart: String) {
    print("Hi, your \(fart) is smelly")
}
testFunk(fart: "flatulent")
...
personName(name: "Mike")
personName(name: "Fartiparty")
 ...
 */
func helloBebe() {
    var greeting = "Καλησπέρα"
    print("\(greeting), world")
    greeting = "Atsaropetuki"
    print("\(greeting), world")
}
helloBebe()
