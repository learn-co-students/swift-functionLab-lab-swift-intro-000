...
func favoriteFood(){
    let food = "steak"
    print("My favorite food to eat is \(food).")
}

favoriteFood()
// Prints "My favorite food is steak."
...
personName(name: "Liz")
// Prints "Hi, Liz, it's nice to meet you."

personName(name: "Bill")
// Prints "Hi, Bill, it's nice to meet you."

personName(name: "Olivia")
// Prints "Hi, Olivia, it's nice to meet you."
...
// Prints "Hi, Spencer, it's nice to meet you."

lastName = "Thomas"
personName(name: lastName)
// Prints "Hi, Thomas, it's nice to meet you."
