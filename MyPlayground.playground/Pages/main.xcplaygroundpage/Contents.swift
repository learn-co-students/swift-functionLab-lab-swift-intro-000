...
// write your code here
func printConstant() {
    let constant = "I'm learning Swift"
    print(constant)
}
...
//The greeting changes based on the argument
/*: question4
...
let finalName = "Warren"
greet(name: "Warren")

//The greeting changes with the variable
/*: question5
...
//I expect 1 and 10 to be printed each time
/*:
