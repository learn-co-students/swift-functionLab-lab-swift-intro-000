 ...
 */
func brotherfinger(name: String) {
    
    print ("Hi \(name) is it snowing?")
    
}



brotherfinger(name: "James")

brotherfinger(name: "Sam")

brotherfinger(name: "Stoe")
 ...
 */
func mummyfinger(name: String) {
    
    var indexfinger = "nadin"
    
    print ("Hi \(name) is it snowing?")}



mummyfinger(name: "jazz")

mummyfinger(name: "nadin")
