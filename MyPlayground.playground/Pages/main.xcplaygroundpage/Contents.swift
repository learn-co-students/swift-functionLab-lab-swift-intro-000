 ...
 */
func successful() {
    let success = "I just wanna be successful"
    print(success)
}
 ...
 */
func someonesName(name: String) {
    print("Hey \(name)! How are you buddy?!")
}

someonesName(name: "Brian")
someonesName(name: "Jeffrey")
someonesName(name: "Sienna")
 ...
 */
func namePrint() {
    var nightName = "Nightie"
    print(nightName)
    nightName = "NightieNight"
    print(nightName)
}
namePrint()
namePrint()
