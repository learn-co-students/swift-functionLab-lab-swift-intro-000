 ...
 */
func theOneThatShallBeNamed() {
    let myName = "Rei"
    print(myName)
}

theOneThatShallBeNamed()
/*: question3
 ### 3. Write a function that takes a person's name as an argument and prints a greeting to the console. Call it several times with different arguments. What do you think you'll see in the console?
 */
//The console will show the greeting with each name inputted.
 ...
 */
//1. The console will show Taylor Swift.

var favoriteArtist = "Taylor Swift"
greeting(name: favoriteArtist)

favoriteArtist = "Stromae"
greeting(name: favoriteArtist)

//2. The console shows Stromae instead of Taylor Swift.
/*: question5
...
//The function prints both numbers.
