 ...
 */
func greetToPerson(person: String) {
    print("Hello \(person), how are you today?")
}

greetToPerson(person: "Mike")

greetToPerson(person: "Dave")

greetToPerson(person: "Lisa")
 ...
 */
let person = "Warner"
greetToPerson(person: person)

var anotherPerson = "Jenny"
greetToPerson(person: anotherPerson)
anotherPerson = "Chelsea"
greetToPerson(person: anotherPerson)
